...
const Header = () => {
    ...
    window.addEventListener("scroll",function(){
        ...
        //when scroll is higher then viewport 200 height  then add show-header class to a tag with scroll-header class//
    ...
    return (
        <header className="header">
            <nav className="nav container">
                <a href="index.html" className="nav__logo">Ritik
                </a>
