...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_sfizgkf', 'template_mf64d1s', form.current, 'DXe5cOVEkio8ORA4m')
      .then(() => {
        setShowAlert(true);
        setTimeout(() => {
          setShowAlert(false);
        ...
        >
          ...
          <div className="contact__info">
            <div className="container__card">
              ...
              <span className="contact__card-data">ritikgupta3326@gmail.com</span>
              <a href="mailto:" className="contact__button">
                Write me
            ...
            <div className="container__card">
              ...
              <span className="contact__card-data">7084743326</span>
              <a
                href="https://api.whatsapp.com/send?phone=7084743326&text=Hello, more information!"
            ...
            <div className="container__card">
              ...
              <span className="contact__card-data">Ritik Gupta</span>
              <a
                href="https://www.facebook.com/ritik.gupta.4147/"
                className="contact__button"
              >
                Connect
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
